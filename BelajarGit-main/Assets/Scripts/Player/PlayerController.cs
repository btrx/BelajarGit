...
public class PlayerController : MonoBehaviour
{
    ...
    //fitur serangan
    //variabel untuk nyimpen input serangan sebelumnya
    public GameObject bulletPrefab;
    //untuk menyimpan posisi spawn peluru
    public Transform bulletSpawnPoint;
    //untuk menyimpan input serangan saat ini
    private float attackInput;
    //menyimpan serangan sebelumnya agar bisa terdeteksi perubahan input serangan
    ...
    void TakeDamage(float dmg)
    {
        ...
        Debug.Log("Player HP: " + currentHP.ToString("F0"));
