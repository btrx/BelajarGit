...
public class peluru : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        // Pastikan komponen Rigidbody2D diambil setiap kali diaktifkan (penting untuk object pooling)
    ...
    void Start()
    {
        // Start bisa dipanggil sekali; OnEnable juga meng-handle pengambilan rb untuk reuse
