...
public class PlayerController : MonoBehaviour
{
    ...
    //variabel untuk menyimpun input serangan sebelumnya
    public GameObject bulletPrefab;
    //variabel untuk menentukan posisi spawn peluru
    public Transform bulletSpawnPoint;
    //variabel untuk melakukan serangan
    private float attackInput;
    //variabel untuk menyimpan input serangan sebelumnya agar bisa mendeteksi perubahan input serangan
    ...
    void Update()
    {
        ...
        //ini untuk ngecek apakah tombol serangan baru saja ditekan
